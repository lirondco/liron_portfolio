...
export default function HomePageEN() {
  ...
  return (
    <section className="home_page_EN" lang='en' dir='ltr'>
      ...
      <div className="body_text_EN">
        <p>
          ...
          Express. <br /> If what you need is not what I listed, still try asking me
          anyway. <br /> I also do maps and graphs.
        </p>
        <p>
          I also love video games, the outdoors, cooking, and sometimes I try
          photography too! <br /> <span className='smaller'>I can also solve the Rubik's cube.</span>
        </p>
      </div>
