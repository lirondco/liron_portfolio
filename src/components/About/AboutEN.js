    ...
    <section id='about_EN' className='section_EN' lang='en' dir='ltr'>
      ...
      <div className='about_text_EN'>
        ...
        <p>
          ...
          using Enzyme, Jest, Chai, Mocha, and Supertest. On the side I enjoy
          analyzing data and creating charts and maps that are comprehensive but
          also easy to read.
        </p>
        <p>
          I have always been interested in computers and pretty maps and graphs
          since I was a child in fourth grade, so much so that I taught myself
          basic HTML and Excel. Learning HTML also helped me discover an
          interest I never thought I'd get hooked on, which is learning new
          languages and studying their history and features. Since then, I have
          come a long way with a Bachelor of Arts in International Relations
          under my name and ability to speak, read, and write in English,
          Hebrew, Spanish, and Tagalog, and most importantly having a set of
          skills that allows me to be a full stack web developer. I also love
          keeping my brain busy, so I never stop learning. Currently I am
          improving my skills in mapping, graphics and UI design.
        </p>
        <p>
